        ...
        <div class="nk-container h-full">
            <div class="flex h-full items-center justify-between gap-4">
                <a href="{{ route('public.home') }}" class="flex items-center gap-3">
                    ...
                    <span>
                        <span class="block text-[20px] font-semibold leading-none">Nad's Kitchen</span>
                        <span class="mt-1 block text-[10px] font-medium uppercase tracking-[0.12em] text-[var(--text-secondary)]">Catering Surabaya</span>
                    </span>
                </a>
        ...
        <div class="nk-container">
            <div class="flex flex-wrap items-start justify-between gap-8">
                <div>
                    ...
                    <p class="mt-2 text-[12px] text-[var(--text-secondary)]">Catering untuk acara keluarga, kantor, dan komunitas.</p>
                </div>
